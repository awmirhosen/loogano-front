<template>
  <div class="w-full flex justify-center mt-10" v-if="profileStore.profileDataLoading">
    <Loader/>
  </div>
  <div v-else class="w-full md:px-24 px-0">
    <div class="w-10/12 mx-auto">
      <!--------- header ------->
      <div class="w-full flex justify-around items-center mt-10" dir="rtl">
        <!------ personal ------>
        <div class="relative cursor-pointer" @click.prevent="informationTab">
          <div ref="firstStepIcon" class="p-3 bg-sky-custom rounded-full">
...
<!--        <div class="w-full bg-sky-custom h-1"></div>-->
        <!---- payment card info ---->
        <div @click.prevent="bankInfoTab" class="relative cursor-pointer">
          <div ref="secondStepIcon" class="transition-all p-3 bg-[#E9E9E9] rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path
...
<!--            </svg>-->
<!--          </div>-->
<!--          <p class="whitespace-nowrap left-1/2 top-16 -translate-x-1/2 absolute text-[14px] text-[#858585]">-->
<!--            ثبت اطلاعات-->
<!--          </p>-->
<!--        </div>-->
      ...
      <div class="w-full mt-16" v-if="profileStore.informationStep === 1">
        <div class="w-full">
          <!------ page title ----->
          ...
          <div class="w-full">
            <div class="w-full mt-10" dir="rtl">
              <FormKit type="form" :actions="false" @submit="submitFirstStep">
                ...
                <div class="w-full flex md:flex-row flex-col justify-center items-center gap-4">
                  <FormKit class="w-full" outer-class="w-full" type="text" name="firstName" label="نام"
                           ...
                           validation="required"
                           :validation-messages="{required: 'نام نمیتواند شامل عدد باشد'}"
                ...
                <div class="w-full flex justify-center items-center gap-4 mt-6">
                  ...
                  <FormKit v-else class="w-full" outer-class="w-full" type="text" name="birthDate" label="سال تولد"
                           ...
                           validation="required"
                           disabled="true"
                           :value="projectEndingDate(profileStore.profileData.birth_date)"
                ...
                <div class="w-full flex md:flex-row flex-col justify-center items-center gap-4 mt-6">
                  ...
                  <FormKit
                      ...
                      :options="provincesSelect"
                  />


                  <select class="w-full p-2 mt-6" :value="profileStore.profileData.city" placeholder="نام شهر استان را انتخاب کنید" ref="cityValue">
                    <option>نام شهر استان را انتخاب کنید</option>
                    <option v-for="cities in citiesSelected" :value="cities.value" >{{ cities.label }}</option>
                  </select>
                ...
                <!------- submit btn ------->
                <div class="w-full flex justify-end gap-4" v-if="!profileStore.stepsLoading" >
                  <div
...
<!--      </div>-->
      ...
      <div class="w-full px-0 md:px-4 mt-16" v-if="profileStore.informationStep === 2">
        <div class="w-full">
          <!------ page title ----->
          <div class="w-full" dir="rtl">
            <p class="text-[23px] text-[#0C5C75]">اطلاعات فردی</p>
              ...
              <FormKit type="form" :actions="false" @submit="submitSecondStep">
                ...
                <div class="w-full flex items-center gap-2">
                  <div class="m-8 w-full">
                    <FormKit type="text" validation="required|length:24,24" dir="ltr" input-class="w-full p-4"
                             label="شماره شبا جدید " inner-class="w-full"
                             :validation-messages="{required: 'فیلد نام الزامیست', length:'شماره شبا شامل 24 عدد میباشد'}"
                             name="sheba"
                             messages-class="text-[14px] text-red-500"
                    />
                  </div>
      ...
      <!------ forth step ------->
      <div class="">
        <div class="w-full px-4" v-if="profileStore.informationStep === 4">
          <!------ page title ----->
          <div class="w-full mt-24" dir="rtl">
            <p class="text-[23px] bg-sky-custom text-white rounded-lg p-2 text-center text-[#0C5C75]">تغییر اطلاعات شما
              ثبت شد</p>
            <!--            <span class="block w-full mt-3 h-[2px] bg-sky-custom"></span>-->
          </div>
        </div>
...
provinces.forEach(item => {
  provincesSelect.push({ label: item.name, value: `${item.id}` });
})

const citiesSelected = reactive([]);
...
cities.forEach(item => {
  citiesSelected.push({ label: item.name, value: `${item.id}`, parent_id: `${item.province_id}` });
})
...
const formatCreditInput = () => {
  ...
  if (creditCardNumber.value === "") {
    realNumber = creditCardNumber.value.replace(/-/gi, '');
...
const provinceChange = (e) => {
  ...
  citiesSelected.splice(0, citiesSelected.length);
...
const submitSecondStep = (formData) => {
  ...
  profileStore.sendCardData(realNumber, formData.sheba);
...
const submitFirstStep = (formData) => {
  ...
  profileStore.profileData.city = cityValue.value.value;
  profileStore.profileData.address = formData.address;


  profileStore.sendPersonalData(formData, profileStore.profileData.birth_date.split(" ")[0], cityValue.value.value);
...
const backTofirst = () => {
  ...
  profileStore.informationStep = 1;
...
const backToSecond = () => {
  ...
  profileStore.informationStep = 2;
}

const informationTab = () => {
  firstStepIcon.value.childNodes[0].childNodes[0].style.stroke = "white"
  firstStepIcon.value.childNodes[0].childNodes[1].style.stroke = "white"
...
const bankInfoTab = () => {
  ...
  firstStepIcon.value.childNodes[0].childNodes[0].style.stroke = "#858585"
  firstStepIcon.value.childNodes[0].childNodes[1].style.stroke = "#858585"
  firstStepIcon.value.classList.add("bg-[#E9E9E9]");
  firstStepIcon.value.classList.remove("bg-sky-custom");
