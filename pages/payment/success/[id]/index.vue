<template>
  <div class="w-full">
    ...
    <!----- white space ----->
    <div class="w-full">
      <p class="w-full text-zinc-400 mt-4 text-[34px] text-center font-morabaa" v-if="!profileStore.walletChargeFlag" dir="rtl">تبریک! شماهم صاحب این ملک شدید</p>
      <p class="w-full text-zinc-400 mt-4 text-[34px] text-center font-morabaa" v-else dir="rtl">کیف پول شما شارژ شد</p>


      <!----- datas table ---->
      <div class="w-full mt-5" v-if="!profileStore.walletChargeFlag">
